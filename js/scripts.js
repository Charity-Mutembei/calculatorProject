...
let birthYear = parseInt (prompt ("Enter your birth year last two numbers e.g 1999 = 99, 2000 = 0, 1902 = 2 etc"));

let b = parseInt (birthYear / 12); 

let bb = b.toFixed(0);

let c = parseInt ((birthYear % 12)*4);
...
if (h < 0) {
console.log("Akan name =",g);
} else {
console.log("Akan name =",f);
}